...
- **Feedback (level 2)**: Hazbot: Go up and look at the instructions under "Vegetation Investigation" again. The instructions tell you how to set up the model! [Show me]
...
### Category 3: Ran the simulation with a zone setting changed but without three different vegetation types assigned (one per zone)

- **Feedback**: Hazbot: Hmm, I don’t see all vegetation types. Let’s set the zones to grass, shrub, and forest! [Show me]
- **Feedback (level 2)**: Hazbot: Go up and look at the instructions under "Vegetation Investigation" again. Did you set each zone to a different type of vegetation? [Show me]
- **Feedback (level 3)**: Hazbot: I'm all out of ideas! Please ask your teacher or a classmate for help! [Okay]
