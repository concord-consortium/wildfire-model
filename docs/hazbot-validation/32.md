...
- **Feedback (level 2)**: Hazbot: Go up and look at the instructions under "Vegetation Investigation" again. The instructions tell you how to set up the model! [Okay]
...
- **Feedback (level 2)**: Hazbot: Go up and look at the instructions under "Vegetation Investigation" again. Did you set each zone to a different type of vegetation? [Okay]
- **Feedback (level 3)**: Hazbot: I'm all out of ideas! Please ask your teacher or a classmate for help! [Okay]
