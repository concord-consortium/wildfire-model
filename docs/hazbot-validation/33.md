...
- **Feedback (level 2)**: Hazbot: Go up and look at the instructions under "Fire Suppression Investigation" again. The instructions tell you how to set up the model! [Okay]
