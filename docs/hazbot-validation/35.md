...
### Category 5: Ran the simulation with 2 vegetations but varied terrain between the zones
...
### Category 6: Ran the simulation with forest with and without suppression, but did not place two sparks (one in each zone)
...
### Category 7: Ran the simulation, set zones with forest and forest w/ suppression,, and placed one spark in each zone
