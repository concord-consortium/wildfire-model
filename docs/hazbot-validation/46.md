...
- **Feedback (level 2)**: Hazbot: Go up and look at the instructions under "Concord Wildfire Investigation" again. [Show me]
...
- **Feedback (repeat click after success)**: Hazbot: Make sure you have answered all the questions on this page! [Got it!] (from the sheet's category 100 row, which replaces any Round 2/3 content on this category)
