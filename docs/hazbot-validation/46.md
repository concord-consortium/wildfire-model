...
- **Feedback (level 2)**: Hazbot: Go up and look at the instructions under "Concord Wildfire Investigation" again. Try using **helitacks** and **firelines** to contain the fire! [Okay]
