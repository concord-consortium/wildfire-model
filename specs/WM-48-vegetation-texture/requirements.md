...
- **`scripts/measure-terrain-textures.mjs` comes across with the tiles and the story requires running it** after any tile change, rather than inheriting it as scaffolding nothing invokes.
